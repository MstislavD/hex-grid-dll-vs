...
namespace HexGrids
{
    public class Vertex
    {
        ...
        public static Vertex operator +(Vertex v1, Vertex v2) => new(v1.X + v2.X, v1.Y + v2.Y);

        public static Vertex operator -(Vertex v1, Vertex v2) => new(v1.X - v2.X, v1.Y - v2.Y);

        public static Vertex operator -(Vertex v) => new(-v.X, -v.Y);

        public static Vertex operator *(double a, Vertex v) => new(a * v.X, a * v.Y);

        public static Vertex operator *(Vertex v, double a) => new(a * v.X, a * v.Y);
